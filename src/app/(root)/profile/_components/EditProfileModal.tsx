...
//       // Add flags to indicate removal of existing images
//       formData.append("removeProfileImage", removeProfileImage.toString());
//       formData.append(
//         "removeBackgroundImage",
//         removeBackgroundImage.toString()
...
//                     {removeBackgroundImage
//                       ? "Background image will be removed."
//                       : "Current background picture, Drag and drop an image here, or click to select"}
//                   </span>
//                 </div>
...
//                     <Avatar className="h-16 w-16 sm:h-20 sm:w-20 border-2 border-gray-200 flex-shrink-0">
//                       {!removeProfileImage &&
//                       (profilePreview || userData.profile_url) ? (
//                         <AvatarImage
//                           src={profilePreview ?? userData.profile_url}
...
//                     {/* Mobile buttons - show inline on mobile */}
...
//                   {/* Desktop layout */}
//                   <div className="hidden sm:flex sm:flex-col gap-2 flex-1">
//                     <p className="text-sm text-gray-500">
//                       {removeProfileImage
//                         ? "Profile picture will be removed."
//                         : userData.profile_url && !profilePreview
...
//                         ? "Profile picture will be removed."
//                         : userData.profile_url && !profilePreview
//                         ? "Current profile picture. Click above to change."
//                         : profilePreview
//                         ? "New profile picture selected."
//                         : "No profile picture selected."}
//                     </p>
...
//                   role="button"
//                   tabIndex={0}
//                   className="w-full border-2 border-dashed rounded-lg p-3 sm:p-4 text-center cursor-pointer relative min-h-[120px] sm:min-h-[160px]"
//                   onDrop={handleBackgroundDrop}
//                   onDragOver={handleDragOver}
//                   onClick={() => backgroundInputRef.current?.click()}
//                   onKeyDown={(e) => {
...
//                         variant="outline"
//                         size="icon"
//                         className="absolute top-1 right-1 sm:top-2 sm:right-2 bg-white/80 hover:bg-white/90 rounded-full h-7 w-7 sm:h-8 sm:w-8"
//                         onClick={(e: React.MouseEvent) => {
//                           e.stopPropagation();
//                           handleRemoveBackgroundImage();
//                         }}
