      ...
      <div className="gradient-bg-light rounded-lg overflow-hidden shadow-lg">
        <div className="p-6 flex flex-col items-center justify-center text-white">
          ...
          <p className="text-sm text-center mb-4 max-w-md opacity-90">
            Sélectionnez une date pour votre rendez-vous avec {doctorName}
          </p>
        </div>
      </div>

      <h2 className="text-2xl font-bold my-4">Détails du rendez-vous</h2>
...
// }: {
//   readonly patientId: string;
//   readonly doctors: { id: string; name: string; specialty?: string }[];
// }) {
//   const router = useRouter();
...
//   async function onSubmit(data: AppointmentSchemaType) {
//     if (!data.doctor_id) {
//       toast.error("Veuillez choisir un médecin");
//       return;
//     }
...
//           <h3 className="text-xl font-semibold mb-2">Prendre un rendez-vous</h3>
//           <p className="text-sm text-center mb-4 max-w-md opacity-90">
//             Sélectionnez un médecin et une date pour votre rendez-vous
//           </p>
//         </div>
//       </div>
...
//               name="doctor_id"
//               control={control}
//               rules={{ required: "Le médecin est requis." }}
//               render={({ field }) => (
