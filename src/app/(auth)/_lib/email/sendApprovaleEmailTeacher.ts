...
//       secure: process.env.EMAIL_SERVER_PORT === "465", // Only secure for port 465
//       auth: {
//         user: process.env.EMAIL_SERVER_USER,
//         pass: process.env.EMAIL_SERVER_PASSWORD,
//       },
...
// //     const transporter = nodemailer.createTransport({
// //       host: process.env.EMAIL_SERVER_HOST,
// //       port: parseInt(process.env.EMAIL_SERVER_PORT ?? "587", 10), // Changed default to 587
// //       secure: process.env.EMAIL_SERVER_PORT === "465", // Only true for port 465
// //       auth: {
// //         user: process.env.EMAIL_SERVER_USER,
// //         pass: process.env.EMAIL_SERVER_PASSWORD,
// //       },
...
// //       tls: {
// //         // Don't fail on invalid certs (for development/testing)
// //         rejectUnauthorized: false,
// //       },
// //       // Force TLS upgrade for non-secure connections
// //       requireTLS: true,
// //     });
