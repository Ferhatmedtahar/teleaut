        ...
        <CardContent className="p-0">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-5 gap-0">
            ...
            <div className="lg:col-span-2 relative overflow-hidden">
              ...
              <div className="relative w-full h-48 sm:h-56 md:h-64 lg:h-full lg:min-h-[300px]">
                <Link href={`/videos/${featuredVideo.id}`}>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center z-10">
                    <Button
                      size="icon"
                      variant="outline"
                      className="rounded-full h-12 w-12 lg:h-16 lg:w-16 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md border-2 border-primary/20 hover:bg-primary hover:text-white hover:border-primary hover:scale-105 transition-all duration-300 shadow-2xl"
                    >
                      <Play className="h-5 w-5 lg:h-7 lg:w-7 ml-1" />
                    </Button>
                  </div>

                  {/* Fixed Image - Remove rounded corners and ensure full coverage */}
                  <Image
                    src={
                    ...
                    fill
                    alt="Featured video"
                    className="object-cover hover:scale-105 transition-transform duration-500 lg:rounded-r-xl"
            ...
            <div className="lg:col-span-3 p-4 lg:p-8 flex flex-col justify-between min-h-[250px] lg:min-h-[300px] bg-gradient-to-br from-background to-primary/5">
              {/* Header Section */}
              <div className="space-y-3 lg:space-y-4">
                {/* Title with enhanced styling */}
                <div>
                  <h3 className="text-lg lg:text-2xl font-bold leading-tight line-clamp-2 mb-2 lg:mb-3 bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
                    {featuredVideo.title}
                  </h3>
                  <p className="text-primary-950 dark:text-primary-50 text-sm lg:text-base line-clamp-2 lg:line-clamp-3 leading-relaxed">
                ...
                <div className="space-y-2 lg:space-y-3">
                  ...
                  <div className="flex flex-wrap gap-1.5 lg:gap-2 my-4">
                    <span className="inline-flex items-center px-2.5 py-1 lg:px-3 lg:py-1.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full text-xs lg:text-sm font-semibold shadow-md">
                    ...
                    <div className="flex flex-wrap gap-1.5 lg:gap-2">
                      {featuredVideo.branch
                        ...
                        .map((branchItem, index) => (
                          <span
                            key={index}
                            className="inline-flex items-center px-2 py-0.5 lg:px-2.5 lg:py-1 bg-gradient-to-r from-purple-100 to-pink-100 text-purple-800 dark:from-purple-900/30 dark:to-pink-900/30 dark:text-purple-200 rounded-full text-xs font-medium border border-purple-200 dark:border-purple-700"
                          >
                            {branchItem}
                          </span>
                        ))}
                      {featuredVideo.branch.length > 2 && (
                        <span className="inline-flex items-center px-2 py-0.5 lg:px-2.5 lg:py-1 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 rounded-full text-xs font-medium">
                          +{featuredVideo.branch.length - 2} autres
                        </span>
                      )}
                    </div>
                  )} */}
              ...
              <div className="space-y-3 lg:space-y-4 pt-4 lg:pt-6 border-t border-primary/20">
                {/* Teacher Info - Enhanced */}
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3 lg:gap-4">
                    <div className="relative">
                      <Avatar className="h-10 w-10 lg:h-14 lg:w-14 ring-2 lg:ring-4 ring-primary/20 shadow-xl">
                        <AvatarImage
                          src={
                        ...
                        />
                        <AvatarFallback className="bg-gradient-to-br from-primary to-primary/70 text-white font-bold text-sm lg:text-lg">
                    ...
                    <div>
                      <p className="text-sm lg:text-base font-bold text-foreground flex items-center gap-1.5 lg:gap-2">
                        {getTeacherName(featuredVideo.teacher)}
                        <Star className="h-3 w-3 lg:h-4 lg:w-4 text-amber-500 fill-current" />
                      </p>
                      <p className="text-xs lg:text-sm text-primary-900 dark:text-primary-100">
                        @
                        {getTeacherName(featuredVideo.teacher)
                          .toLowerCase()
                          .replace(/\s+/g, "")}
                  ...
                  <div className="text-right">
                    <div className="flex items-center gap-1.5 lg:gap-2 text-primary-900 dark:text-primary-100 mb-1">
...
//                   width={600}
//                   alt="Featured video"
//                   className="object-cover w-full h-full rounded-t-xl lg:rounded-t-none lg:rounded-l-xl hover:scale-105 transition-transform duration-500"
//                 />
//               </Link>
//             </div>
