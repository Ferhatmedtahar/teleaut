...
export default function UserDropDownMenu({
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger
        asChild
        className="p-5 focus:outline-none focus:ring-0 ring-0 shadow-none  text-black bg-primary-100/10  hover:bg-primary-200/50 dark:hover:bg-primary-50/30 dark:text-white"
      >
